...
class JvmMd5HashDigest : MyMd5Digest() {
    ...
    fun updateFromFileRecursively(
        ...
        file.walk().sortedBy {
            ...
            it.path.split(file.myFileSystem.separator).none { it in ignoreAllWithPathParts }
        }.filter {
            it.path.split(file.myFileSystem.separator)
